...
sudo ./root.x86_64/bin/arch-chroot root.x86_64 << EOF
	...
	pacman -Syu --noconfirm bash bzip2 coreutils dhcpcd gcc-libs gettext glibc grep gzip inetutils iproute2 iputils less libutil-linux licenses logrotate psmisc sed shadow sysfsutils systemd-sysvcompat tar texinfo usbutils util-linux which nano
