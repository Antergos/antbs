...
class ServerStatus(RedisHash, metaclass=RedisSingleton):
    ...
    attrib_lists = dict(
        string=['current_status', 'container', 'github_token',
                ...
                'generating_lock_id', 'ethemes_url', 'et_count_key', 'makepkg_pkglist_cmd'],
        ...
        path=['APP_DIR', 'STAGING_REPO', 'MAIN_REPO', 'STAGING_64', 'STAGING_32',
              ...
              'OLD_ISO_IMAGES_DIR', 'CNCHI_TRANSLATIONS_DIR', 'ISO_TRANSLATIONS_DIR', 'ISO_TRANSLATIONS_DESTDIR']
    )
