...
Test.prototype = {
	...
	setup: function() {
		...
		// allow utility functions to access the current test.py environment
		// TODO why??
...
QUnit = {
	...
	// Specify the number of expected assertions to gurantee that failed test.py (no assertions are run at all) don't slip through.
